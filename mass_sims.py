from net_structures import OneLayerCNN, TwoLayerCNN, ThreeLayerCNN, get_omniglot_loaders, get_mnist_loaders
...
results = mass_test_cnn_models(trainloader, testloader, three_layer_configs, fc_sizes, num_epochs=5)
